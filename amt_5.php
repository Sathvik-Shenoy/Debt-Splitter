...
?>
    ...
    <body>
        <div id="bg"></div>
        <form action="calc_5.php" method="post" id="resultformclass">
            ...
            <label>Amount <?php echo $name1 ?> has to pay to <?php echo $name5 ?></label>
            <div class="form-field">
            <input type="text" name="amt_15" placeholder="Enter the amount">
            <br>
    </div>
            <label>Amount <?php echo $name2 ?> has to pay to <?php echo $name5 ?></label>
            <div class="form-field">
            <input type="text" name="amt_25" placeholder="Enter the amount">
            <br>
    </div>
            <label>Amount <?php echo $name3 ?> has to pay to <?php echo $name5 ?></label>
            <div class="form-field">
            <input type="text" name="amt_35" placeholder="Enter the amount">
            <br>
    </div>
            <label>Amount <?php echo $name4 ?> has to pay to <?php echo $name5 ?></label>
            <div class="form-field">
            <input type="text" name="amt_45" placeholder="Enter the amount">
            <br>
    </div>
            <label>Amount <?php echo $name5 ?> has to pay to <?php echo $name1 ?></label>
            <div class="form-field">
            <input type="text" name="amt_51" placeholder="Enter the amount">
            <br>
    </div>
            <label>Amount <?php echo $name5 ?> has to pay to <?php echo $name2 ?></label>
            <div class="form-field">
            <input type="text" name="amt_52" placeholder="Enter the amount">
            <br>
    </div>
            <label>Amount <?php echo $name5 ?> has to pay to <?php echo $name3 ?></label>
            <div class="form-field">
            <input type="text" name="amt_53" placeholder="Enter the amount">
            <br>
    </div>
            <label>Amount <?php echo $name5 ?> has to pay to <?php echo $name4 ?></label>
            <div class="form-field">
            <input type="text" name="amt_54" placeholder="Enter the amount">
            <br>
    </div>
        <br>
